...
FILE_NAME = "BULAT_KUTLUGALLYAMOV.sql"
# create indexes
with conn.cursor() as cur:
...
x = x1 + x2 + x3 + x4
print(f"Query 1 improvement: {x1}\t after={x1n.cost}\t\tbefore={x1o.cost}\t{float(x1n.cost)/float(x1o.cost)}")
print(f"Query 2 improvement: {x2}\t after={x2n.cost}\t\tbefore={x2o.cost}\t{float(x2n.cost)/float(x2o.cost)}")
print(f"Query 3 improvement: {x3}\t after={x3n.cost}\t\tbefore={x3o.cost}\t{float(x3n.cost)/float(x3o.cost)}")
print(f"Query 4 improvement: {x4}\t after={x4n.cost}\t\tbefore={x4o.cost}\t{float(x4n.cost)/float(x4o.cost)}")
